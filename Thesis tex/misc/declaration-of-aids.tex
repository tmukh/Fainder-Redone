...
\hline
Translation (German abstract) & 2 & DeepL: translation of technical terminology and selected phrasings from the English abstract & Final wording revised by me; both abstracts state identical claims \\
\hline
Spell checking & 1 & Grammarly: spelling and grammar checks on the thesis text & Corrections reviewed and applied by me \\
\hline
\end{tabular}
...
\noindent All scientific claims, including the four-ceiling characterisation, negative composability, pre-flight ceiling identification, and the dispatch policy, are my own work.

All methodology choices, formulations of hypotheses, and interpretations of the empirical results are my own work. AI-generated output was used for drafting, formatting, and consistency checks, but not for content generation. I bear sole responsibility for the content of this thesis, and for any errors or omissions that may remain.